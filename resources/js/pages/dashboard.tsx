                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <Card className="relative overflow-hidden border-none bg-linear-to-br from-indigo-600 via-violet-600 to-purple-700 text-primary-foreground shadow-lg shadow-indigo-500/20">
                        ...
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-semibold tracking-wide text-indigo-50/80">
                                Total Balance
                            </CardTitle>
                            <div className="glass rounded-full bg-white/20 p-2">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-xs font-medium text-indigo-100/60">
                                Net worth across all accounts
                            </p>
                        </CardContent>
                    </Card>
                    <Card className="group border-border/50 bg-card/60 backdrop-blur-sm transition-all hover:shadow-md">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    ...
                                    goals.map((goal) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="h-2 w-full overflow-hidden rounded-full bg-secondary/50 shadow-inner">
                                                    <div
