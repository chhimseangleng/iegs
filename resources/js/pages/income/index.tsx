...
import { DollarSign, TrendingUp, Calendar, Plus, Pencil, Trash2 } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Highest Income</CardTitle>
                            <TrendingUp className="h-4 w-4 text-muted-foreground" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">${highestIncome.toFixed(2)}</div>
                    ...
                    <form onSubmit={submitAdd}>
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="date" type="date" value={data.income_date} onChange={e => setData('income_date', e.target.value)} />
                                {errors.income_date && <p className="text-sm text-destructive">{errors.income_date}</p>}
                            </div>
                            <div className="grid gap-2">
                    ...
                    <form onSubmit={submitUpdate}>
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="edit-date" type="date" value={data.income_date} onChange={e => setData('income_date', e.target.value)} />
                                {errors.income_date && <p className="text-sm text-destructive">{errors.income_date}</p>}
                            </div>
                            <div className="grid gap-2">
